...
$$
  q_1=q_{t}
\\v_1=v_{t}
\\q_{n}=q_{t}+k_{n-1}\times\delta t
\\v_{n}=v_{t}+\frac{-k_{n-1}\cdot q_{n-1}}{m} \times \delta t
$$
...
实验中，弹簧对物块的作用力为 $f$，物块的位移为 $q$，物块的速度为 $qdot$，均为Eigen::VectorXd类型，长度resize为1，即1x1的矩阵。
